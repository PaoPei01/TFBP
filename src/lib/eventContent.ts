...
export const eventContentBySlug: Record<string, EventContent> = {
  ...
  'parent-orientation-staff-2569': {
    ...
    staffRecruitment: {
      ...
      dressCodeTh: 'ชุดช็อปถูกระเบียบ',
      dutiesTh: [
        'ฝ่ายจราจรและอำนวยทาง (10 คน)',
        'ฝ่ายพยาบาลและดูแลความปลอดภัย (5 คน)',
        'ฝ่ายลงทะเบียน (15 คน)',
        'ฝ่ายสวัสดิการ (10 คน)',
        'ฝ่ายสิทธิประโยชน์และจำหน่ายสินค้า (5 คน)',
        'ฝ่ายสนับสนุนระบบลงทะเบียน (IT) (3 คน)',
        'ฝ่าย Backstage และประสานงานเวที (5 คน)',
        'ฝ่ายทั่วไป (77 คน)',
      ],
      importantDatesTh: [
      ...
      applicationFields: [
        ...
        { key: 'preferred_duties', labelTh: 'ฝ่ายที่สนใจ', type: 'multiselect', required: true, optionsTh: ['ฝ่ายจราจรและอำนวยทาง', 'ฝ่ายพยาบาลและดูแลความปลอดภัย', 'ฝ่ายลงทะเบียน', 'ฝ่ายสวัสดิการ', 'ฝ่ายสิทธิประโยชน์และจำหน่ายสินค้า', 'ฝ่ายสนับสนุนระบบลงทะเบียน (IT)', 'ฝ่าย Backstage และประสานงานเวที', 'ฝ่ายทั่วไป'] },
