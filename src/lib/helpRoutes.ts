...
export const routeHelpTopics = [
  ...
  { pattern: '/admin/people/update-requests', topicId: 'admin.people-update-requests' },
  { pattern: '/events/:eventSlug/staff/apply', topicId: 'events.staff-application' },
  { pattern: '/events/:eventSlug/profile-check', topicId: 'events.identity-cmu-mail' },
  { pattern: '/events/:eventSlug/staff/application-status', topicId: 'events.application-status-check' },
